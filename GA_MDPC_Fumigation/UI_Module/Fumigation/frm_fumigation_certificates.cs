...
{
    public partial class frm_fumigation_certificates : Form
    {
        public frm_fumigation_certificates()
        {
            InitializeComponent();
        }
        ...
        void do_new()
        {
            frm_fumigation_certificate the_form = new frm_fumigation_certificate();
        ...
        private void frm_fumigation_certifactes_Load(object sender, EventArgs e)
        {
            load_list();
        }
    }
