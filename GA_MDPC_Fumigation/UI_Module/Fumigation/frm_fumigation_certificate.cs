...
using GA_MDPC_Fumigation.UI_Module.Basic;
...
{
    public partial class frm_fumigation_certificate : Form
    {
        public frm_fumigation_certificate()
        {
            InitializeComponent();
        }
        ...
        void select_exporter_selection()
        {
        ...
        public string selected_consignee_id = "";
        public string selected_consignee_address_id = "";
        private void btn_consignee_Click(object sender, EventArgs e)
        {
            select_consignee the_selection = new select_consignee();
            the_selection.selected_value1 = selected_consignee_id;
            the_selection.selected_text1 = tb_consignee_name.Text;
            if (the_selection.ShowDialog() == DialogResult.Yes)
            {
                selected_consignee_id = the_selection.selected_value1;
                tb_consignee_name.Text = the_selection.selected_text1;
                selected_consignee_address_id = the_selection.selected_value2;
                tb_consignee_address.Text= the_selection.selected_text2;
            }
            tb_commodity.Focus();
        }
        ...
        public string selected_authorized_signature_id = "";
        private void btn_authorized_signature_Click(object sender, EventArgs e)
        {
            Select_authorized_signature the_selection = new Select_authorized_signature();
            the_selection.selected_value1 = selected_authorized_signature_id;
            the_selection.selected_text1 = tb_authorized_signature.Text;
            if (the_selection.ShowDialog() == DialogResult.Yes)
            {
                selected_authorized_signature_id = the_selection.selected_value1;
                tb_authorized_signature.Text = the_selection.selected_text1;
            }
         //   dtp_fumigation.Focus();

        }

        private void frm_fumigation_certifacte_Load(object sender, EventArgs e)
        {
        ...
        bool do_save_record_verify()
        {
            ...
            else if (tb_exporter_address.Text.Trim() == "")
            {
                is_error = true;
                tb_exporter_address.Focus();
                lbl_message.Text = "Need to type Exporter Address";
            }
            else if (tb_consignee_name.Text.Trim() == "")
            {
                is_error = true;
                tb_consignee_name.Focus();
                lbl_message.Text = "Need to type Consignee Name";
            }
            else if (tb_consignee_address.Text.Trim() == "")
            {
                is_error = true;
                tb_consignee_address.Focus();
            ...
            else if (tb_place_of_loading.Text.Trim() == "")
            {
                ...
                lbl_message.Text = "Need to type Place of loading";
            }
            ...
            else if (tb_place_of_issued.Text.Trim() == "")
            {
                is_error = true;
                tb_place_of_issued.Focus();
                lbl_message.Text = "Need to type Place Issued";
            }
            else if (tb_authorized_signature.Text.Trim() == "")
            {
                is_error = true;
                tb_authorized_signature.Focus();
                lbl_message.Text = "Need to type Authorized Signature";
            }
            return is_error;
        }
        ...
        Report_fumigation _Report_fumigation = new Report_fumigation();
        ...
        void do_print()
        {
            _Report_fumigation.fc_no = tb_FC_NO.Text;
            _Report_fumigation.ShowDialog();
        }
