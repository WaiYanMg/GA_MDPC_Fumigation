...
{
    public partial class frm_temperature : Form
    {
        public frm_temperature()
        {
            InitializeComponent();
        }
        ...
        private void frm_temperature_Load(object sender, EventArgs e)
        {
        ...
        string do_save_record()
        {
            ...
            Mst_Temperature the_record = new Mst_Temperature();
            ...
            try
            {
                ...
                if (record_id != "")
                {
                    the_record = (from c in dc.Mst_Temperatures where record_id == c.TemperatureID select c).FirstOrDefault();

                }
                else
                {
                    the_record = new Mst_Temperature()
                    {
                        ...
                        TemperatureID = Guid.NewGuid().ToString(),
                        ModifiedOn = DateTime.Now,
                        ModifiedBy = Program.get_current_user_id()

                    };
                    dc.Mst_Temperatures.InsertOnSubmit(the_record);
                }
                ...
                the_record.Temperature = tb_temperature.Text;
                ...
                {
                    record_id = the_record.TemperatureID;
        ...
        { // user access;
                      ...
                      DialogResult.Yes)
            {
                Linq_FumigationDataContext dc = new Linq_FumigationDataContext(Program.get_main_connection());
                Mst_Temperature the_record = new Mst_Temperature();
                the_record = (from c in dc.Mst_Temperatures where c.Active == true && c.TemperatureID == record_id select c).FirstOrDefault();
        ...
        void do_load()
        {
            ...
            Linq_FumigationDataContext dc = new Linq_FumigationDataContext(Program.get_main_connection());
            Mst_TemperatureView the_result = (from c in dc.Mst_TemperatureViews where c.Active == true && c.TemperatureID == record_id select c).FirstOrDefault();
        ...
        private void gv_list_DoubleClick(object sender, EventArgs e)
        {
            ...
            record_id = the_result.TemperatureID;
