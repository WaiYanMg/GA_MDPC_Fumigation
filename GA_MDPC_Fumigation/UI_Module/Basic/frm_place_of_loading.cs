...
{
    public partial class frm_place_of_loading : Form
    {
        public frm_place_of_loading()
        {
            InitializeComponent();
        }
        ...
        private void frm_place_of_loading_Load(object sender, EventArgs e)
        {
        ...
        bool do_save_record_verify()
        {
            lbl_message.Text = "";
            bool is_error = false;
            if (tb_place_of_loading.Text.Trim() == "")
            {
                is_error = true;
        ...
        string do_save_record()
        {
            ...
            Mst_PlaceOfLoading the_record = new Mst_PlaceOfLoading();
            ...
            try
            {
                ...
                if (record_id != "")
                {
                    the_record = (from c in dc.Mst_PlaceOfLoadings where record_id == c.PlaceOfLoadingID select c).FirstOrDefault();

                }
                else
                {
                    the_record = new Mst_PlaceOfLoading()
                    {
                        ...
                        PlaceOfLoadingID = Guid.NewGuid().ToString(),
                        ModifiedOn = DateTime.Now,
                        ModifiedBy = Program.get_current_user_id()

                    };
                    dc.Mst_PlaceOfLoadings.InsertOnSubmit(the_record);
                }
                ...
                the_record.PlaceOfLoading = tb_place_of_loading.Text;
                ...
                {
                    record_id = the_record.PlaceOfLoadingID;
        ...
        { // user access;
                      ...
                      DialogResult.Yes)
            {
                Linq_FumigationDataContext dc = new Linq_FumigationDataContext(Program.get_main_connection());
                Mst_PlaceOfLoading the_record = new Mst_PlaceOfLoading();
                the_record = (from c in dc.Mst_PlaceOfLoadings where c.Active == true && c.PlaceOfLoadingID == record_id select c).FirstOrDefault();
        ...
        void do_load()
        {
            ...
            Linq_FumigationDataContext dc = new Linq_FumigationDataContext(Program.get_main_connection());
            Mst_PlaceOfLoadingView the_result = (from c in dc.Mst_PlaceOfLoadingViews where c.Active == true && c.PlaceOfLoadingID == record_id select c).FirstOrDefault();
        ...
        void load_list()
        {
            ...
            List<Mst_PlaceOfLoadingView> records = (from c in dc.Mst_PlaceOfLoadingViews
                                                    where c.Active == true
        ...
        {
            Mst_PlaceOfLoadingView the_result = (Mst_PlaceOfLoadingView)gc_list.GetRow(gc_list.GetSelectedRows().FirstOrDefault());
            record_id = the_result.PlaceOfLoadingID;
