...
{
    public partial class select_destination : Form
    {
        ...
        {
            UI_Module.Basic.frm_destination the_form = new UI_Module.Basic.frm_destination();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.DestinationID;
                this.selected_text1 = the_result.DestinationName;
                this.DialogResult = DialogResult.Yes;
            }
