...
{
    public partial class select_conveyance : Form
    {
        public select_conveyance()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_conveyance the_form = new UI_Module.Basic.frm_conveyance();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.CarrierID;
                this.selected_text1 = the_result.CarrierName;
                this.DialogResult = DialogResult.Yes;
            }
