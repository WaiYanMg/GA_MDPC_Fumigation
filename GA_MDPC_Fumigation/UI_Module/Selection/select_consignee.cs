...
{
    public partial class select_consignee : Form
    {
        public select_consignee()
        {
            InitializeComponent();
        }
        ...
        {
            Mst_Consignee_AddressView the_result = (Mst_Consignee_AddressView)gc_list.GetRow(gc_list.GetSelectedRows().FirstOrDefault());
            this.selected_value1 = the_result.ConsigneeID;
            this.selected_text1 = the_result.ConsigneeName;
            this.selected_value2 = the_result.ConsigneeAddressID;
            this.selected_text2 = the_result.ConsigneeAddress;
        ...
        void search()
        {
            ...
            List<Mst_Consignee_AddressView> records = (from c in dc.Mst_Consignee_AddressViews
                                                 ...
                                                 c.ConsigneeAddress.Contains(tb_search.Text)
                                                      ...
                                                      orderby c.ConsigneeName, c.ConsigneeAddress
                                                       select c).ToList();
        ...
        {
            UI_Module.Basic.frm_consignee the_form = new UI_Module.Basic.frm_consignee();
