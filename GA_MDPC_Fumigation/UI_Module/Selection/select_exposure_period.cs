...
{
    public partial class select_exposure_period : Form
    {
        public select_exposure_period()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_exposure_period the_form = new UI_Module.Basic.frm_exposure_period();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.ExpouserPeriodID;
                this.selected_text1 = the_result.ExpouserPeriod;
                this.DialogResult = DialogResult.Yes;
            }
