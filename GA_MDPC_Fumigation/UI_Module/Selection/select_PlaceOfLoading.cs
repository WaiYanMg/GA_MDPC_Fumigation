...
{
    public partial class select_PlaceOfLoading : Form
    {
        public select_PlaceOfLoading()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_place_of_loading the_form = new UI_Module.Basic.frm_place_of_loading();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.PlaceOfLoadingID;
                this.selected_text1 = the_result.PlaceOfLoading;
                this.DialogResult = DialogResult.Yes;
            }
