...
{
    public partial class Select_authorized_signature : Form
    {
        public Select_authorized_signature()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_authorized_signature the_form = new UI_Module.Basic.frm_authorized_signature();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.SignatureID;
                this.selected_text1 = the_result.SignatureName;
                this.DialogResult = DialogResult.Yes;
            }
