...
{
    public partial class select_chemical : Form
    {
        public select_chemical()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_chemical the_form = new UI_Module.Basic.frm_chemical();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.ChemicalID;
                this.selected_text1 = the_result.ChemicalName;
                this.DialogResult = DialogResult.Yes;
            }
