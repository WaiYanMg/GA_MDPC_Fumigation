...
{
    public partial class select_units : Form
    {
        public select_units()
        {
            InitializeComponent();
        ...
        {
            UI_Module.Basic.frm_unit the_form = new UI_Module.Basic.frm_unit();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.UnitID;
                this.selected_text1 = the_result.UnitName;
                this.DialogResult = DialogResult.Yes;
            }
