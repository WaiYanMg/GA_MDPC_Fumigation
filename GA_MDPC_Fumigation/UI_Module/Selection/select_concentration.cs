...
{
    public partial class select_concentration : Form
    {
        public select_concentration()
        {
            InitializeComponent();
        }
        ...
        {
            UI_Module.Basic.frm_concentration the_form = new UI_Module.Basic.frm_concentration();
        ...
        private void select_form_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter && gc_list.RowCount > 0)
            {
                ...
                this.selected_value1 = the_result.ConcentrationID;
                this.selected_text1 = the_result.Concentration;
                this.DialogResult = DialogResult.Yes;
            }
